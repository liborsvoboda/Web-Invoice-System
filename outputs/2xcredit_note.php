...
$data1=mysql_query("select * from credit_header where id='".securesql($id)."' ");
$data2=mysql_query("select * from credit_items where credit_id='".securesql($id)."' ");
...
//$pdf->Cell(100,6,mysql_result($data,0,1),0,0,'L');$pdf->Cell(91,6,dictionary("revenue_credit_note",$lang).": ".mysql_result($data1,0,1),0,0,'R');
//$pdf->Ln(5);
$pdf->SetFont('tahomabd','',20);
$pdf->Cell(100,12,mysql_result($data,0,1),0,0,'L');
$pdf->SetFont('tahomabd','',12);
$pdf->Cell(91,6,dictionary("revenue_credit_note",$lang).": ".mysql_result($data1,0,1),0,0,'R');
$pdf->Ln(5);


$pdf->SetFont('tahomabd','',12);
$pdf->Cell(100,6,"",0,0,'L');$pdf->Cell(91,6,dictionary("for_invoice_no",$lang).": ".mysql_result($data1,0,2),0,0,'R');
$pdf->Ln(5);
...
$pdf->SetFont('tahoma','',10);
$pdf->MultiCell(191,6,"\n".mysql_result($data1,0,13),'TLRB','J');
...
$pdf->Ln(10);$pdf->Cell(191,6,"",'B',0,'L');$pdf->Ln(16);
